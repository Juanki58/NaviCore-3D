...
| **Script** | `tools/experiments/run_mount_experiment.py` | idem |
...
| Script | Propósito |
|--------|-----------|
| `tools/experiments/run_yaw_init_experiment.py` | Inicialización yaw desde GPS bearing |
| `tools/experiments/run_h3_experiment.py` | H0 vs H2 vs H3 con montaje Rodrigues |
| `tools/analysis/analyze_yaw_init_timing.py` | Timing del primer fix GPS vs init |
...
| Script | `tools/experiments/run_h4_experiment.py`, `tools/experiments/run_h4_sweep.py` |
|--------|------------------------------------------|
...
| Script | Propósito |
|--------|-----------|
| `tools/experiments/run_h5_sync_analysis.py` | Histograma Δt GPS–IMU |
| `tools/experiments/run_h5_grid_search.py` | Grid ruido proceso Q × ruido NHC R |
...
| Script | `tools/experiments/run_h6_sync_audit.py` |
|--------|------------------------|
...
| Script | `tools/experiments/run_h7_gnss_audit.py`, `tools/experiments/run_h7_gnss_chain_audit.py` |
|--------|------------------------------------------------------|
...
| Script | `tools/experiments/run_h7b_unified_origin.py` |
|--------|-------------------------------|
...
| Script | `tools/experiments/run_h8_propagation_audit.py` |
|--------|-------------------------------|
...
| Script | `tools/experiments/run_h9_predict_only_isolation.py` |
|--------|-------------------------------------|
...
| ID | Script | Pregunta |
|----|--------|----------|
| **H9a** | `tools/experiments/run_h9a_gravity_init.py`, `tools/experiments/run_h9a_gravity_alignment_audit.py` | ¿Init roll/pitch desde gravedad corrige tilt? |
| **H9.1** | `tools/experiments/run_h9_1_tilt_diagnostic.py` | Diagnóstico observacional inclinación |
| **H9b** | `tools/experiments/run_h9b_attitude_propagation_audit.py` | ¿Salto por integración giro vs paso gravedad? |
| **H9c** | `tools/experiments/run_h9c_orientation_ref_audit.py` | ¿EKF vs Orientation o solo accel? |
| **H9d** | `tools/experiments/run_h9d_gravity_subtraction_audit.py` | ¿Error antes o después de restar g? |
| **Chain** | `tools/experiments/run_propagation_chain_audit.py` | Cadena completa a_raw → a_lin |
| **Heading** | `tools/experiments/run_rb_forward_heading_audit.py` | `R_bn·e_x` vs GPS bearing |
| **Triada** | `tools/experiments/run_gravity_triad_audit.py` | pred / ref / meas en body |
| **Referencias** | `tools/experiments/audit_reference_chain.py` | Eslabones Sensor→EKF |
| **Convenciones** | `tools/experiments/audit_attitude_conventions.py` | Coherencia quat/DCM + cadena |
...
| Script | Propósito |
|--------|-----------|
| `tools/analysis/analyze_real_run.py` | Análisis GPS vs filtro, actitud vs Orientation |
| `tools/experiments/audit_imu_chain.py` | Cadena IMU sin EKF; exporta `imu_mount.json` |
| `tools/analysis/parse_mobile_log.py` | CSV Sensor Logger → replay unificado |
| `tools/lib/geodesy.py` | LLA↔NED WGS84 (réplica Python) |
| `tools/experiments/run_gnss_innovation_audit.py` | Innovaciones GNSS detalladas |
...
|--------|---------------------|
| `tools/experiments/run_h3_experiment.py` | `h3_experiment_report.json` |
| `tools/experiments/run_h4_experiment.py` | `h4_experiment_report.json` |
| `tools/experiments/run_h5_grid_search.py` | `h5_grid_report.json` |
| `tools/experiments/run_h6_sync_audit.py` | `h6_sync_audit_report.json` |
| `tools/experiments/run_h7_gnss_chain_audit.py` | `h7_gnss_chain_report.json` |
| `tools/experiments/run_h8_propagation_audit.py` | `h8_propagation_audit_report.json` |
| `tools/experiments/run_h9_predict_only_isolation.py` | `h9_predict_only_report.json` |
| `tools/experiments/run_h9b_attitude_propagation_audit.py` | `h9b_attitude_propagation_report.json` |
| `tools/experiments/run_h9c_orientation_ref_audit.py` | `h9c_orientation_ref_report.json` |
| `tools/experiments/run_h9d_gravity_subtraction_audit.py` | `h9d_gravity_subtraction_report.json` |
| `tools/experiments/run_propagation_chain_audit.py` | `propagation_chain_audit_report.json` |
| `tools/experiments/run_rb_forward_heading_audit.py` | `rb_forward_heading_report.json` |
| `tools/experiments/run_gravity_triad_audit.py` | `gravity_triad_report.json` |
| `tools/experiments/audit_reference_chain.py` | `reference_chain_audit.json` |
| `tools/experiments/audit_attitude_conventions.py` | `attitude_convention_audit.json` |
